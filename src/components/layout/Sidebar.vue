        ...
        <div class="sidebar-wrapper active">
                ...
                <div class="d-flex justify-content-between">
                    <div class="logo">
                        <router-link :to="{ name: 'Dashboard' }">
                            <img src="/assets/static/images/logo/logo.png" alt="Logo" srcset="">
                        </router-link>
                    </div>
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li :class="{ active: route.name === 'Dashboard' }" class="sidebar-item">
                    ...
                    <li :class="{ active: isActive('/invoices') }" class="sidebar-item has-sub">
                        ...
                        <ul class="submenu" :class="{ active: isActive('/invoices') }">
                            <li class="submenu-item" :class="{ active: route.name === 'Invoices' }">
                                <router-link class="submenu-link" :to="{ name: 'Invoices' }">All</router-link>
                            </li>
                            <li class="submenu-item" :class="{ active: route.name === 'NewInvoice' }">
                                <router-link class="submenu-link" :to="{ name: 'NewInvoice' }">Create new</router-link>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li :class="{ active: isActive('/reports') }" class="sidebar-item has-sub">
                        ...
                        <ul class="submenu" :class="{ active: isActive('/reports') }">
                            <li class="submenu-item" :class="{ active: route.name === 'AnnualReport' }">
                                <router-link class="submenu-link" :to="{ name: 'AnnualReport' }">Annual report</router-link>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li :class="{ active: isActive('/settings') }" class="sidebar-item has-sub">
                        ...
                        <ul class="submenu" :class="{ active: isActive('/settings') }">
                            ...
                            <li class="submenu-item" :class="{ active: route.name === 'Authentication' }">
                                <router-link class="submenu-link" :to="{ name: 'Authentication' }">Authentication</router-link>
                            </li>
                        </ul>
                    </li>
                </ul>
