                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                            ...
                            <li>
                                <router-link class="dropdown-item" :to="{ name: 'Organization', params: { id: user?.organizationId } }">
                            ...
                            <li><a class="dropdown-item" @click="logout" href="javascript:void(0)"><i class="icon-mid bi bi-box-arrow-left me-2"></i> Logout</a></li>
                        </ul>
                    </div>
                </div>
            </div>
